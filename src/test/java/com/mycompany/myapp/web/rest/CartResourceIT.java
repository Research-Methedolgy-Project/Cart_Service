...
class CartResourceIT {
    ...
    public static Cart createEntity(EntityManager em) {
        Cart cart = new Cart().product_id(DEFAULT_PRODUCT_ID).user_id(DEFAULT_USER_ID).dateTime(DEFAULT_DATE_TIME);
        return cart;
    }
    ...
    public static Cart createUpdatedEntity(EntityManager em) {
        Cart cart = new Cart().product_id(UPDATED_PRODUCT_ID).user_id(UPDATED_USER_ID).dateTime(UPDATED_DATE_TIME);
        return cart;
    }
    ...
    void createCart() throws Exception {
        ...
        assertThat(testCart.getProduct_id()).isEqualTo(DEFAULT_PRODUCT_ID);
        assertThat(testCart.getUser_id()).isEqualTo(DEFAULT_USER_ID);
        assertThat(testCart.getDateTime()).isEqualTo(DEFAULT_DATE_TIME);
    }
    ...
    void putNewCart() throws Exception {
        ...
        updatedCart.product_id(UPDATED_PRODUCT_ID).user_id(UPDATED_USER_ID).dateTime(UPDATED_DATE_TIME);
        ...
        Cart testCart = cartList.get(cartList.size() - 1);
        assertThat(testCart.getProduct_id()).isEqualTo(UPDATED_PRODUCT_ID);
        assertThat(testCart.getUser_id()).isEqualTo(UPDATED_USER_ID);
        assertThat(testCart.getDateTime()).isEqualTo(UPDATED_DATE_TIME);
    }
    ...
    void partialUpdateCartWithPatch() throws Exception {
        ...
        partialUpdatedCart.user_id(UPDATED_USER_ID);
    ...
    void fullUpdateCartWithPatch() throws Exception {
        ...
        partialUpdatedCart.product_id(UPDATED_PRODUCT_ID).user_id(UPDATED_USER_ID).dateTime(UPDATED_DATE_TIME);
